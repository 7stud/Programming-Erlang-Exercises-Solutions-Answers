...
Below is a modern makefile (see my answers for chapter 10 for an explanation of how the makefile works) that I created for compiling just the files discussed in the chapter, which were:
```
example1.c
example1_driver.c
erl_comm.c
